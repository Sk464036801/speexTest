...
JNIEXPORT jint JNICALL Java_com_speextest_dao_Speex_open(JNIEnv *env,
...
JNIEXPORT jint Java_com_speextest_dao_Speex_encode(JNIEnv *env, jobject obj,
...
JNIEXPORT jint JNICALL Java_com_speextest_dao_Speex_decode(JNIEnv *env,
...
JNIEXPORT jint JNICALL Java_com_speextest_dao_Speex_getFrameSize(JNIEnv *env,
		jobject obj) {
